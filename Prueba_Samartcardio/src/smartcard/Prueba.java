...
public class Prueba{
    ...
    public static void main(String[] args) throws Exception {
    	...
    	ACOS3_card.FormatCard((byte)0x00, (byte)0x01, (byte)0xFF, (byte)0xFF);//Dar formato a la tarjeta. Arg 1 y 2: ID archivo registro datos; Arg 3 y 4: Tamaño de memoria asignado
